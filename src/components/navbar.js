    ...
    <nav data-role="Header" className="navbar-navbar">
      ...
      <div className="navbar-right-side">
        <div className="navbar-links-container">
          ...
          <Link to="/about-me" className="navbar-navlink2">
            {props.text1}
          </Link>
          <Link to="/work" className="navbar-navlink3">
            {props.text2}
          </Link>
        ...
        <div className="navbar-nav">
          ...
          <div className="navbar-right-side1">
            <div className="navbar-links-container1">
              <span className="navbar-text">{props.text5}</span>
              <span className="navbar-text1">{props.text6}</span>
              <span className="navbar-text2">{props.text7}</span>
